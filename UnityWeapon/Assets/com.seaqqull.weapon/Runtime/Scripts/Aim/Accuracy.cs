...
namespace Weapons.Aiming
{
    public class Accuracy : BaseMonoBehaviour
    {
        ...
        [SerializeField] private Color _flowColor = new(0, 0, 0, 1);
        ...
        private void OnDrawGizmos()
        {
            ...
            if (_parent != null)
            {
                ...
                Gizmos.DrawLine(_parent.position, _parent.position + _parent.forward * _distance);
            }
        ...
        public Line GetDirectionVector()
        {
            ...
            var end = CalculateVector(position + (_parent.forward * _distance), rotation, _end.Radius * (1 - _end.Accuracy));
            var begin = CalculateVector(position, rotation, _begin.Radius * (1 - _begin.Accuracy));
